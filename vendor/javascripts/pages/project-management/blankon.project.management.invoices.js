'use strict';
var BlankonProjectManagementInvoices = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonProjectManagementInvoices.handleDatatable();
            BlankonProjectManagementInvoices.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/invoices/invoices.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                    ...
                    },
                    {
                        ...
                        'render': function ( data, type, full, meta ) {
                            return '<div class="btn-group">' +
                                ...
                                '<li><a href="#" class="btn-messages">Send Messages</a></li>' +
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonProjectManagementInvoices.handleActionViewDatatable();
                    BlankonProjectManagementInvoices.handleActionEditDatatable();
                    BlankonProjectManagementInvoices.handleActionMessagesDatatable();
                    BlankonProjectManagementInvoices.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonProjectManagementInvoices.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonProjectManagementInvoices.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                $('.invoice-id', $dlg).html(data[1]);
                $('.invoice-client', $dlg).html(data[3]);
                $('.invoice-amount', $dlg).html(data[4]);
                $('.invoice-due', $dlg).html(data[5]);
            });
        ...
        handleActionEditDatatable: function () {
            ...
            $('#modal-edit-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Ref ID</label>' +
                    '<div class="col-sm-9">' +
                    ...
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Due Created</label>' +
                    '<div class="col-sm-9">' +
                    ...
                    '<option '+selectStatNew+'>New</option>' +
                    '<option '+selectStatExp+'>Overdue</option>' +
                    '</select>' +
                    '</div>' +
                    '</div>' +
                    '</form>';
        ...
        // =========================================================================
        // ACTION MESSAGE ROW DATATABLES
        // =========================================================================
        handleActionMessagesDatatable: function () {
            $('#datatable-sample').on('click', '.btn-messages', function(){
                showModalDialog(this);
            });

            $('#modal-messages-datatable').modal({ show: false });

            $('#modal-messages-datatable').on('show.bs.modal', function (e){
                var $dlg = $(this);
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<label class="col-sm-3 control-label">ID :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static">' + $('<div/>').text(data[1]).html() + ' ('+$('<div/>').text(data[3]).html()+')</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
            ...
            function showModalDialog(elBtn){
                $('#modal-messages-datatable').data('btn', elBtn);
                $('#modal-messages-datatable').modal('show');
            }
        },
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonProjectManagementInvoices.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonProjectManagementInvoices.init();