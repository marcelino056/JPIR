'use strict';
var BlankonProjectManagementInvoiceItems = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonProjectManagementInvoiceItems.handleDatatable();
            BlankonProjectManagementInvoiceItems.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/invoices/invoice-item.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonProjectManagementInvoiceItems.handleActionViewDatatable();
                    BlankonProjectManagementInvoiceItems.handleActionEditDatatable();
                    BlankonProjectManagementInvoiceItems.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonProjectManagementInvoiceItems.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonProjectManagementInvoiceItems.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                $('.invoice-id', $dlg).html(data[0]);
                $('.invoice-product-name', $dlg).html(data[1]);
                $('.invoice-product-description', $dlg).html(data[2]);
                $('.invoice-qty', $dlg).html(data[3]);
                $('.invoice-unit-price', $dlg).html(data[4]);
                $('.invoice-tax-rate', $dlg).html(data[5]);
                $('.invoice-tax', $dlg).html(data[6]);
                $('.invoice-total-price', $dlg).html(data[7]);
            });
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonProjectManagementInvoiceItems.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonProjectManagementInvoiceItems.init();