'use strict';
var BlankonProjectManagementTicket = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonProjectManagementTicket.handleDatatable();
            BlankonProjectManagementTicket.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/project-management/datatable-sample.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonProjectManagementTicket.handleActionViewDatatable();
                    BlankonProjectManagementTicket.handleActionEditDatatable();
                    BlankonProjectManagementTicket.handleActionReplyDatatable();
                    BlankonProjectManagementTicket.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonProjectManagementTicket.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonProjectManagementTicket.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionEditDatatable: function () {
            ...
            $('#modal-edit-datatable').on('show.bs.modal', function (e){
                ...
                var $table = $($dlg.data('btn')).closest('table');
                var data = $table.DataTable().row($tr).data();
                var selectStatNew = (data[6] == 'new') ? "selected" : "";
                var selectStatExp = (data[6] == 'expired') ? "selected" : "";
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<option '+selectStatExp+'>Expired</option>' +
                    '</select>' +
                    '</div>' +
                    '</div>' +
                    '</form>';
        ...
        // =========================================================================
        // ACTION REPLY ROW DATATABLES
        // =========================================================================
        handleActionReplyDatatable: function () {
            $('#datatable-sample').on('click', '.btn-reply', function(){
                showModalDialog(this);
            });

            $('#modal-reply-datatable').modal({ show: false });

            $('#modal-reply-datatable').on('show.bs.modal', function (e){
                var $dlg = $(this);
            ...
            function showModalDialog(elBtn){
                $('#modal-reply-datatable').data('btn', elBtn);
                $('#modal-reply-datatable').modal('show');
            }
        },
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonProjectManagementTicket.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonProjectManagementTicket.init();