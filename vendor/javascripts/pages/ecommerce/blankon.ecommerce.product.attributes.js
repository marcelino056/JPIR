'use strict';
var BlankonEcommerceProductAttributes = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceProductAttributes.handleTagList();
        ...
        handleTagList: function () {
            ...
            var tableDom = $('#datatable-attribute');
            // Using DOM
...
// Call main app init
BlankonEcommerceProductAttributes.init();