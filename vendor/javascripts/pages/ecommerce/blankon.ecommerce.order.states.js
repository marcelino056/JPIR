'use strict';
var BlankonEcommerceOrderStates = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceOrderStates.handleDatatable();
            BlankonEcommerceOrderStates.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-states.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonEcommerceOrderStates.handleActionViewDatatable();
                    BlankonEcommerceOrderStates.handleActionEditDatatable();
                    BlankonEcommerceOrderStates.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonEcommerceOrderStates.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonEcommerceOrderStates.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">State Order :</label>' +
                    '<div class="col-sm-9">' +
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonEcommerceOrderStates.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonEcommerceOrderStates.init();