'use strict';
var BlankonEcommerceProductList = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceProductList.handleDatatable();
            BlankonEcommerceProductList.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonEcommerceProductList.handleActionViewDatatable();
                    BlankonEcommerceProductList.handleActionEditDatatable();
                    BlankonEcommerceProductList.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonEcommerceProductList.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonEcommerceProductList.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonEcommerceProductList.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonEcommerceProductList.init();