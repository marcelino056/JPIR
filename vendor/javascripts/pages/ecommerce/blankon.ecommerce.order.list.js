'use strict';
var BlankonEcommerceOrderList = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceOrderList.handleDatatable();
            BlankonEcommerceOrderList.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonEcommerceOrderList.handleActionViewDatatable();
                    BlankonEcommerceOrderList.handleActionEditDatatable();
                    BlankonEcommerceOrderList.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonEcommerceOrderList.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonEcommerceOrderList.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonEcommerceOrderList.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonEcommerceOrderList.init();