'use strict';
var BlankonEcommerceDiscountList = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceDiscountList.handleDatatable();
            BlankonEcommerceDiscountList.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-product-discount.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonEcommerceDiscountList.handleActionViewDatatable();
                    BlankonEcommerceDiscountList.handleActionEditDatatable();
                    BlankonEcommerceDiscountList.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonEcommerceDiscountList.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonEcommerceDiscountList.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Reward amount :</label>' +
                    '<div class="col-sm-9">' +
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonEcommerceDiscountList.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonEcommerceDiscountList.init();