'use strict';
var BlankonEcommerceOrderCountries = function () {
    ...
    return {
        ...
        // =========================================================================
        init: function () {
            BlankonEcommerceOrderCountries.handleDatatable();
            BlankonEcommerceOrderCountries.handleDatatableColors();
        },
        ...
        handleDatatable: function () {
            ...
            var table = $('#datatable-sample').DataTable({
                'ajax': {
                    'url': getBaseURL+'/assets/admin/data/datatable-countries.json'
                },
                'columnDefs': [
                    {
                        'targets': 0,
                ...
                'drawCallback' : function(oSettings) {
                    ...
                    BlankonEcommerceOrderCountries.handleActionViewDatatable();
                    BlankonEcommerceOrderCountries.handleActionEditDatatable();
                    BlankonEcommerceOrderCountries.handleActionDeleteDatatable();
                }
            });
            ...
            $('.change-language').on('click', function () {
                ...
                var tableLanguage = BlankonEcommerceOrderCountries.handleNotificationDatatable('Table language '+$(this).data('title'));
            ...
            $('a.toggle-column').on( 'click', function (e) {
                ...
                // Call notifications
                BlankonEcommerceOrderCountries.handleNotificationDatatable($(this).text()+' Column');
        ...
        handleActionViewDatatable: function () {
            ...
            $('#modal-view-datatable').on('show.bs.modal', function (e){
                ...
                var html = '<form class="form-horizontal">' +
                    ...
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static text-capitalize">' + $('<div/>').text(data[1]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Code :</label>' +
                    '<div class="col-sm-9">' +
                    '<p class="form-control-static text-capitalize">' + $('<div/>').text(data[2]).html() + '</p>'+
                    '</div>' +
                    '</div>' +
                    '<div class="form-group">' +
                    ...
                    '</div>' +
                    '<div class="form-group">' +
                    '<label class="col-sm-3 control-label">Other States :</label>' +
                    '<div class="col-sm-9">' +
        ...
        handleDatatableColors: function () {
            $('.dropdown-table-colors .dropdown-list').on('click', function () {
                ...
                // Call notifications
                BlankonEcommerceOrderCountries.handleNotificationDatatable('Table color '+$(this).data('color'));
            });
        }
...
// Call main app init
BlankonEcommerceOrderCountries.init();