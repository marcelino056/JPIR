...
class DataControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create datum" do
    assert_difference('Datum.count') do
      post data_url, params: { datum: { mobile_id: @datum.mobile_id, type: @datum.type, value: @datum.value } }
    end
  ...
  test "should update datum" do
    patch datum_url(@datum), params: { datum: { mobile_id: @datum.mobile_id, type: @datum.type, value: @datum.value } }
