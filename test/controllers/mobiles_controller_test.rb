...
class MobilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mobile" do
    assert_difference('Mobile.count') do
      post mobiles_url, params: { mobile: { mac_address: @mobile.mac_address, modelo: @mobile.modelo } }
    end
  ...
  test "should update mobile" do
    patch mobile_url(@mobile), params: { mobile: { mac_address: @mobile.mac_address, modelo: @mobile.modelo } }
