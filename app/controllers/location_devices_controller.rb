class LocationDevicesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @location_device.save
        ...
        format.json { render :show, status: :created, location: @location_device }
      else
  ...
  def update
    respond_to do |format|
      if @location_device.update(location_device_params)
        ...
        format.json { render :show, status: :ok, location: @location_device }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to location_devices_url, notice: 'Location device was successfully destroyed.' }
  ...
  private
    ...
    def location_device_params
      params.require(:location_device).permit(:access_point_id, :coordenate_id)
    end
end
